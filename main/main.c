...
");
    ...
    // Continue only if not in emulator mode (emulator never reaches here)
#ifndef CONFIG_ZCLAW_EMULATOR_MODE
...
#endif  // !CONFIG_ZCLAW_EMULATOR_MODE (normal path ends here)
